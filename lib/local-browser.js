...
#screen,#inputLayer{position:absolute;inset:0;width:100%;height:100%;border:0}
...
#status{position:fixed;inset:0;display:grid;place-items:center;background:#fff;color:#777;font-size:14px;pointer-events:none}
#status[hidden]{display:none}
</style>
</head>
<body>
<iframe id="screen" title="DeepSeek 网页" src="/specsrelay/browser/frame"></iframe>
...
(() => {
  ...
  const refreshFrame = () => {
    ...
    screen.src = "/specsrelay/browser/frame?t=" + Date.now();
  };
